    ...
    ...middleware('guest', [
        {
            ...
            {path: '/menus', name:'menus', component: () => import('../views/admin/Menu'), meta: { requiresAuth: true }},
            ...
            {path: '/role-privileges', name:'privileges', component: () => import('../views/admin/Privilege'), meta: { requiresAuth: true },},
        ]
        },
    ]),
